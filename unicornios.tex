...
\begin{frame}{Contando granos de arena}
 ...
 \visible<2->{$\bullet$~Muchos, ¿verdad? Concretamente, $10^{17}$ granos.}
...
\includegraphics[width=\textwidth,height=0.30\textheight,keepaspectratio]{sumo_electron.jpg}
     \visible<2->{\includegraphics[width=\textwidth,height=0.30\textheight,keepaspectratio]{sumo_positron.jpg}}
