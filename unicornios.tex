...
\begin{frame}{Una playa entre Donosti y Pekín}
  ...
  \column{0.6\textwidth}
    ...
    $\bullet$~Un reactor nuclear es un infierno radioactivo encerrado en un búnker. Las desintegraciones en su interior producen $\sim 2 \times 10^{20}$  (doscientos trillones) neutrinos por segundo. Si cada neutrino fuera un grano de arena la playa se entendería desde Donostia hasta Pekín.
...
% $4.3 \times 10^{17}$ segundos. 
 ...
 $\bullet$~Supongamos un genio que alarga cada segundo de la vida del Universo para que sea tan largo como toda la vida del universo en años. Pues bien, ese es el tiempo promedio que necesitaría un átomo (por ejemplo de xenon) para desintegrarse via doble beta sin neutrinos. 
 
  $\bullet$~Otra manera de verlo. Si cada año que tarda un átomo de xenon en desintegrarse doble beta fuera un grano de arena en nuestra playa, su longitud sería unas 3000 veces la distancia al sol (\emph{Playa de Babilonia}).
...
\begin{frame}{Babilonia revisitada}
  ...
  $\bullet$~¿Cómo es posible que un experimento pueda registrar una desintegración doble beta sin neutrinos? Se trata otra vez de la lotería de Babilonia. El xenon es un gas noble, presente (en trazas) en la atmósfera, que \emph{podría} desintegrarse vía $\beta\beta0\nu$. \emph{En una tonelada de xenon hay tantos átomos como granos de arena en la playa de Babilonia}
         
$\bullet$~ ¿Cual es el resultado de la lotería? Hay tantas papeletas como granos de arena en la playa de Babilonia y el juego se repite tantas veces como granos de arena en la playa de Babilonia. El resultado, asombrosamente, es del orden de uno. 

$\bullet$~ Es decir, en una tonelada de xenon, esperamos que se produzca una desintegración doble beta sin neutrinos al año. ¿Podemos detectarla?
...
\begin{columns}
\column{0.4\textwidth}
\includegraphics[width=\textwidth,height=0.45\textheight,keepaspectratio]{pajar.jpg}

\includegraphics[width=\textwidth,height=0.45\textheight,keepaspectratio]{donosti_pajar.png}
...
$\bullet$~La señal de la desintegración $\beta\beta0\nu$ del xenon son dos electrones que \emph{se materializan} en algún punto de la cámara y cuya <<traza>> es registrada por los sensores.  
...
$\bullet$~ O, parafraseando a David Deutch: <<Si Atenas hubiera prevalecido sobre Esparta, ustedes y yo, queridos amigos, seríamos ya inmortales y habríamos llegado a las estrellas>>.
...
\begin{frame}{Rilke}
  ...
  \includegraphics[width=\textwidth,height=0.85\textheight,keepaspectratio]{unicornios.png}
