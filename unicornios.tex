...
\begin{frame}{La energía del electrón}
  ...
  \column{0.5\textwidth}
    \begin{tikzpicture}
      \node[anchor=south west,inner sep=0] (img) {\includegraphics[width=\textwidth]{balance2.png}};
...
\begin{frame}{Proyecto Poltergeist}
  ...
  \column{0.5\textwidth}
     \includegraphics[width=\textwidth,height=0.42\textheight,keepaspectratio]{poltergeist.pdf}
      ...
      \includegraphics[width=\textwidth,height=0.40\textheight,keepaspectratio]{interaction_nue.png}
...
\vspace{1ex}
\begin{center}
\includegraphics[width=0.7\textwidth,height=0.35\textheight,keepaspectratio]{doubleOrNothingCover.png}
\end{center}
\end{columns}
\end{frame}
...
\begin{columns}
\column{0.5\textwidth}
\includegraphics[width=\textwidth,height=0.65\textheight,keepaspectratio]{double_beta_cartoon.png}
...
\begin{frame}{El ángel y la montaña}
  \begin{columns}
  \column{0.4\textwidth}
   \includegraphics[width=\textwidth,height=0.85\textheight,keepaspectratio]{eternidad.png}
...
\begin{frame}{Babilonia revisitada}
  \begin{columns}
  \column{0.4\textwidth}
   \includegraphics[width=\textwidth,height=0.85\textheight,keepaspectratio]{babilonia2.png}
...
\includegraphics[width=\textwidth,height=0.42\textheight,keepaspectratio]{donosti_pajar.png}
...
\begin{columns}
\column{0.50\textwidth}
\includegraphics[width=\textwidth,height=0.43\textheight,keepaspectratio]{next-ia.png}

\includegraphics[width=\textwidth,height=0.45\textheight,keepaspectratio]{energy-balance.png}
...
\begin{columns}
\column{0.40\textwidth}
\includegraphics[width=\textwidth,height=0.85\textheight,keepaspectratio]{cities.png}
